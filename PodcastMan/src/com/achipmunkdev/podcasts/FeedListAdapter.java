    ...
    extends BaseAdapter
{
    ...
    public FeedListAdapter( Activity context, SyndFeed inputFeed )
    {
        ...
        //new FeedRetriever().execute(feedUrl);
    ...
    public class FeedRetriever extends AsyncTask<String, Void, SyndFeed> {
